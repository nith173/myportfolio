...
document.querySelectorAll('.project-card, .skill-card, .contact-item, .stat-card, .featured-card').forEach(el => {
    el.style.opacity = '0';
...
function showNotification(message, type = 'info') {
    ...
    notification.style.cssText = `
        ...
        top: 100px;
        right: 20px;
        background: ${type === 'success' ? '#4ecdc4' : type === 'error' ? '#ff6b6b' : '#4ecdc4'};
        color: white;
        padding: 1rem 1.5rem;
        border-radius: 10px;
...
// Initialize typing effect when page loads (only on homepage)
...
style.textContent = `
    ...
    .project-card, .skill-card, .contact-item, .featured-card {
        cursor: pointer;
    }
